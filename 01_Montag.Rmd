...
+ Lesen Sie den Allbus 2018 in Stata ein.
  ...
  + Sie finden den Allbus 2018 in [ILIAS](www.ilias.gesis.org).
...
+ Auf ILIAS finden Sie auch eine csv-Datei des Allbus 2018. Lesen Sie diese Dateiversion in Stata ein! (Siehe [weitere Anmerkungen](#otherfmts))
