...
### Scatterplot für kategoriale Merkmale
...
Eine Möglichkeit ist ein sog. Jitter, dazu hängen wir `jitter(5 5)` an einen `twoway scatter`:
```{stata scatter_jitter1, eval = F}
twoway scatter mi02 educ, by(sex) jitter(5 5) ///
