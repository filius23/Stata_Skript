...
Für Mittelwertvergleich gibt es insgesamt zwei Aspekte, anhand derer sich t-Tests allgemein unterscheiden:
...
(@) Sind Befragte, die in den 1960er Jahren geboren wurden, signifikant früher aus dem Elternhaus ausgezogen als Befragte, die in den 1970er Jahren geboren wurden?
  ...
  + Wählen Sie alle Befragten aus, die zwischen 1960 und 1979 geboren wurden (`yborn` gibt das Geburtsjahr an) und für die das Alter beim Auszug aus dem Elternhaus vorliegt (`dg12 > 0`).
...
(@) Haben kleinere Frauen einen signifikant höheren BMI als größere?
