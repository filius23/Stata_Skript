...
(@) Haben die Einkommensangaben von Haustierbesitzer\*innen eine höhere Varianz als die Einkommensangaben von Nicht-Haustierbesitzer\*innen ? 
...
| `inc` | Einkommen
  ...
  + Laden Sie den Allbus (`Allbus_2018.dta`) und wählen Sie alle Angaben für in Vollzeit arbeitende Befragte (`work==1`) aus, die ein Einkommen (`inc`) größer als 0 angebeben haben. (siehe [Hinweise](#readin091) ) 
...
```{r,out.width = "100%", fig.height= 8, dpi = 1000, echo=F, fig.align="center" , eval = T, message=F, warning =F}
...
### Einlesen und auswählen für Ü9-1 {#readin091}


### Einlesen und auswählen für Ü9-2 {#binom_help}
