...
graph box inc
graph export "04_box.png", replace
```

```{r box1_plot, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_box.png")
```
...
graph export "04_twoway1.png", replace
```
...
graph twoway (scatter inc age) (lfit inc age)
graph export "04_line_scatter.png", replace
```

```{r twoway2_plot, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_line_scatter.png")
```
...
graph export "04_line_scatter_theme.png", replace
```

```{r theme_plot, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_line_scatter_theme.png")
```
...
graph export "04_line_scatter_theme2.png", replace
```

```{r theme_plot2, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_line_scatter_theme2.png")
```
...
graph twoway (scatter inc age) (lfit inc age), scheme(lean2) ///
  legend(cols(2) pos(6))
graph export "04_line_scatter_theme3.png", replace
```

```{r theme_plot3, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_line_scatter_theme3.png")
```

### Beschriftung

```{r lab, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_beschriftungen.png")
```
...
graph export "04_bunter_scatter.png", replace
```

```{r colored_scatter_print, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_bunter_scatter.png")
```
...
graph export "04_bunter_line_scatter.png", replace
```

```{r colored_line_scatter_print, echo = F,out.width = "80%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("04_bunter_line_scatter.png")
```
...
<!--chapter:end:11_Fortgeschrittene_Datenaufbereitung.Rmd-->
